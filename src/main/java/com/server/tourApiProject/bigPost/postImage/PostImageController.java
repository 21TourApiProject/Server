...
public class PostImageController {
    ...
    public void createPostImage(@PathVariable("postContent") String postContent, @RequestBody List<PostImageParams> postImageParams){
        postImageService.createPostImage(postContent,postImageParams);
    }
