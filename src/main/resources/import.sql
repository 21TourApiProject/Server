...
--관측지
    INSERT INTO OBSERVATION (OBSERVATION_ID, OBSERVATION_NAME, LINK, LATITUDE, LONGITUDE, ADDRESS, PHONE_NUMBER, OPERATING_HOUR, ENTRANCE_FEE, PARKING, PARKING_IMG, INTRO, OBSERVE_TYPE, OUTLINE ) VALUES (1, '천문대1', 'https://www.yao.or.kr:451/', 37.54892296550104, 127.00557633, '강원 영월군 영월읍 천문대길 397', '010-1111-1111', '13:00~16:00', '6000원', '주차는 여기에', 'img url', '여기는 어쩌구의저쩌구한줄소개', '천문대', '개애요' );
...
-- 별자리
    ...
    INSERT INTO CONSTELLATION (CONST_ID, CONST_BEST_MONTH, CONST_IMAGE, CONST_NAME, CONST_PERSONALITY, CONST_STORY, SPRING_CONST_MTD, SUMMER_CONST_MTD, FALL_CONST_MTD, WINTER_CONST_MTD, START_DATE, END_DATE ) VALUES (1, '1,3월에 잘보임', 'www.image1', '물고기자리', '물고기자리 성격', '물고기자리 설화', '물고기자리 봄 관측법', '물고기자리 여름 관측법', '물고기자리 가을 관측법', '물고기자리 겨울 관측법', '2021-08-16', '2021-08-17');
