...
--주변 관광지
   ...
   INSERT INTO NEAR_TOURIST_DATA (NEAR_TOURIST_DATA_ID, TOURIST_DATA_ID, FIRST_IMAGE, CONTENT_ID, TITLE, ADDR1, CAT3NAME, OVERVIEW_SIM) VALUES (2, 125266, 'http://tong.visitkorea.or.kr/cms/resource/62/219162_image2_1.jpg', 125406, '토함산자연휴양림', '대구광역시 달성군 유가읍 일연선사길 61', '자연휴양림', '비슬산 자연휴양림은 대견봉(...');
