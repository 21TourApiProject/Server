...
--관측지
    INSERT INTO OBSERVE_POINT (OBSERVE_POINT_ID, OBSERVE_POINT_NAME) VALUES (1, '천문대1');
    INSERT INTO OBSERVE_POINT (OBSERVE_POINT_ID, OBSERVE_POINT_NAME) VALUES (2, '천문대2');
    INSERT INTO OBSERVE_POINT (OBSERVE_POINT_ID, OBSERVE_POINT_NAME) VALUES (3, '천문대3');
    INSERT INTO OBSERVE_POINT (OBSERVE_POINT_ID, OBSERVE_POINT_NAME) VALUES (4, '천문대4');
    INSERT INTO OBSERVE_POINT (OBSERVE_POINT_ID, OBSERVE_POINT_NAME) VALUES (5, '천문대5');

--별자리
    INSERT INTO CONSTELLATION (CONST_ID, CONST_IMAGE, CONST_STORY, SPRING_CONST_MTD, SUMMER_CONST_MTD, FALL_CONST_MTD, WINTER_CONST_MTD, CONST_BEST_MONTH, CONST_PERSONALITY) VALUES (1, 'www.constImage1.url', '물병자리 설화', '물병자리 봄 관측법', '물병자리 여름 관측법', '물병자리 가을 관측법', '물병자리 겨울 관측법', '2월,3월에 잘 관측됨', '물병자리 성격' );