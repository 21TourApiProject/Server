...
-- 별자리
    INSERT INTO CONSTELLATION (CONST_ID, CONST_BEST_MONTH, CONST_IMAGE, CONST_NAME, CONST_STORY, SPRING_CONST_MTD, SUMMER_CONST_MTD, FALL_CONST_MTD, WINTER_CONST_MTD, START_DATE, END_DATE ) VALUES (0, '1,3월에 잘보임', 'https://wallpapercave.com/wp/YVnW7ve.jpg', '물병자리', '물병자리 설화', '물병자리 봄 관측법', '물병자리 여름 관측법', '물병자리 가을 관측법', '물병자리 겨울 관측법',  '2021-08-25', '2021-08-26');
